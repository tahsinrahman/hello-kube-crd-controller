...
import (
	...
	samplecontrollercomv1alpha1 "github.com/tahsinrahman/hello-kube-crd-controller/pkg/apis/samplecontroller.com/v1alpha1"
	versioned "github.com/tahsinrahman/hello-kube-crd-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/tahsinrahman/hello-kube-crd-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/tahsinrahman/hello-kube-crd-controller/pkg/client/listers/samplecontroller.com/v1alpha1"
...
func NewFilteredFooInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&samplecontrollercomv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecontrollercomv1alpha1.Foo{}, f.defaultInformer)
}
